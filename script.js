...
function openGmail() {
  const email = "lavishdodeja69@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Lavisha Dodeja Resume.pdf"; // Path to your resume file
  link.download = " Lavish Dodeja Resume"; // Name for the downloaded file
